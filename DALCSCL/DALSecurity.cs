...
namespace DALCSCL
{
    public class DALSecurity
    {
        ...
        public DataSet GetUserStakeHOlderType(string UserName)
        {
            SqlParameter[] Parameters = new SqlParameter[1];

            Parameters[0] = new SqlParameter("@NameUser", UserName);
            return objDALCommon.ExecuteProcedure_select("sreGetFitnessTypeWise", Parameters);
        }
        ...
        public DataSet GetASOUserAcc(string Username)
        {
            SqlParameter[] Parameters = new SqlParameter[1];

            Parameters[0] = new SqlParameter("@UserName", Username);
            return objDALCommon.ExecuteProcedure_select("sreGetASOUser", Parameters);


        }


        public DataSet GetASOAccId(int ASOID)
        {
            SqlParameter[] parameters = new SqlParameter[1];

            parameters[0] = new SqlParameter("@ASOID", ASOID);
            return objDALCommon.ExecuteProcedure_select("sreGetASOacc", parameters);
        }
        ...
        public int UpdateImages(byte[] NImage)
        {
            SqlParameter[] Parameters = new SqlParameter[1];

            Parameters[0] = new SqlParameter("@Imgbytes", NImage);

            return objDALCommon.ExecuteProcedure("SupPromotions", CommandType.StoredProcedure, Parameters);
        }
