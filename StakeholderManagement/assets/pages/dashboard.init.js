...
!function($) {
  ...
  Dashboard.prototype.init = function() {
      ...
      this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#86c233','#0e86e7', '#745af1']);
      ...
      this.createDonutChart('morris-donut-example', $donutData, ['#0e86e7','#86c233', '#745af1']);
  },
  //init
