<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Stock.aspx.cs"
    Inherits="StakeholderManagement.Stock" %>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <asp:Label runat="server" Visible="false" Text="Fitness Type"></asp:Label>

                        <dx:BootstrapComboBox Visible="false" ID="ddlFitnessType" DataSourceID="SqlStakeHolderTypes"
                            OnSelectedIndexChanged="ddlFitnessType_SelectedIndexChanged" AutoPostBack="true"
