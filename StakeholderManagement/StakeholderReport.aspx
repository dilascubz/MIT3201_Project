<%@ Page Title="Stakeholder Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StakeholderReport.aspx.cs" Inherits="StakeholderManagement.StakeholderReport" %>
            ...
            <div class="row">
                <div class="page-banner-content col">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li><a href="my-account.html">Stakeholder Report</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container overflow-x-auto">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <dx:BootstrapGridView runat="server" DataSourceID="SqlGetUsers" ID="gdStakeHolders"
                        KeyFieldName="Id" 
                        ...
                        <Columns>
                            ...
                            <dx:BootstrapGridViewComboBoxColumn Width="100px" FieldName="StakeHolderTypeId" Name="CategoryId" VisibleIndex="3" Caption="StakeHolderCategory">
                                <PropertiesComboBox Width="200px" DataSourceID="odsStakeholderTypes" TextField="Name" ValueField="Id">
                                    <ValidationSettings>
