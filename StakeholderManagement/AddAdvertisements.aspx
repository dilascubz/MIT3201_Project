<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddAdvertisements.aspx.cs" Inherits="StakeholderManagement.AddAdvertisements" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-section section section-padding">
        <div class="container overflow-x-auto">
            ...
            <dx:BootstrapGridView runat="server" ID="gdAdvertisement" KeyFieldName="Id" DataSourceID="SqlgetAdvertisement"
                ...
                OnAfterPerformCallback="gdAdvertisement_AfterPerformCallback"
    ...
    <asp:SqlDataSource ID="SqlStakeHolderTypes" runat="server"
        ConnectionString="<%$ ConnectionStrings:StakeHolderManagmentConnectionString %>" SelectCommand="sreGetFitnesstypes"
