<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserAccountsz.aspx.cs" Inherits="StakeholderManagement.UserAccountsz" %>
                        ...
                        <ContentCollection>
                            <dx:ContentControl runat="server">
                                ...
                                <dx:BootstrapGridView runat="server" DataSourceID="SqlGetUsers" ID="gdAccounts"
                                    ...
                                    OnCellEditorInitialize="gdAccounts_CellEditorInitialize"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:BootstrapGridViewTextColumn FieldName="ASO" VisibleIndex="2" Visible="true" Caption="ASO">
                                        ...
                                        <DetailRow>
                                            <div class="row ml-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 no-padding">
                                                            <label class="form-group">Created Date & Time :</label>
                                                        </div>
                                                        <div class="col-md-4 no-padding">
                                                            <asp:Label runat="server"
                                                                Text='<%# DataBinder.Eval(Container.DataItem, "CreatedDateTime")%>'
                                                                CssClass="label-text"></asp:Label>
                                                        </div>
                                ...
                                <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" GridViewID="gdAccounts" runat="server"></dx:ASPxGridViewExporter>
                            </dx:ContentControl>
                        </ContentCollection>
                    </dx:TabPage>
                            ...
                            <dx:ContentControl runat="server">
                                <dx:BootstrapGridView runat="server" DataSourceID="SqlGetHomeOwners" ID="gdHomeOwner"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:BootstrapGridViewTextColumn Visible="true" FieldName="ASO" VisibleIndex="2" Width="400px" Caption="ASO">
                                            <SettingsEditForm Visible="false" />
                                            <PropertiesTextEdit Width="200px">
                                            </PropertiesTextEdit>
                                        </dx:BootstrapGridViewTextColumn>
                                        ...
                                        <dx:BootstrapGridViewComboBoxColumn Width="100px" FieldName="Source" Name="Source" VisibleIndex="9" Caption="Source">
                                            <PropertiesComboBox Width="200px">
                                                <Items>
                                                    ...
                                                    <dx:BootstrapListEditItem Text="Canvassing" Value="1"></dx:BootstrapListEditItem>
                                                    <dx:BootstrapListEditItem Text="Social Media Lead" Value="2"></dx:BootstrapListEditItem>
                                                    <dx:BootstrapListEditItem Text="Web Lead" Value="3"></dx:BootstrapListEditItem>
                                        ...
                                        <dx:BootstrapGridViewComboBoxColumn Width="100px" FieldName="SiteType" Name="Site Type" VisibleIndex="10" Caption="Site Type">
                                            <PropertiesComboBox Width="200px">
                                                <Items>
                                                    ...
                                                    <dx:BootstrapListEditItem Text="Single Storey" Value="1"></dx:BootstrapListEditItem>
                                                    <dx:BootstrapListEditItem Text="Two Storey" Value="2"></dx:BootstrapListEditItem>
                                                    <dx:BootstrapListEditItem Text="Multiple Storey" Value="3"></dx:BootstrapListEditItem>
                                        ...
                                        <dx:BootstrapGridViewComboBoxColumn Width="100px" FieldName="SiteCondition" Visible="false" Name="Source" VisibleIndex="12" Caption="Site Condition">
                                            <PropertiesComboBox Width="200px">
                                                <Items>
                                                    <dx:BootstrapListEditItem Text="New" Value="0"></dx:BootstrapListEditItem>
                                                    <dx:BootstrapListEditItem Text="Ongoing" Value="1"></dx:BootstrapListEditItem>
